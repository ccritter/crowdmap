...
Currently, the expected config is: [{address: '/test', type: 'echo', source:'orientation', prompt: 'Text'}] for example TODO maybe include a size component to determine how much of the audience is grouped into it? 0% wuold be a solo?
...
class Client {
  ...
  remove() {
    ...
    this.udpPort.options.remoteAddress = "127.0.0.1"; // undefined;
    this.udpPort.options.remotePort = 57121; // undefined;
    return crowd;
  }
