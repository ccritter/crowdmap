...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 314.25, 98.0, 29.5, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 314.25, 122.0, 230.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 314.25, 50.0, 40.0, 22.0 ],
					"text" : "t i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 314.25, 74.0, 264.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.5, 295.315368999999976, 79.0, 22.0 ],
					"text" : "s makeconfig"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.5, 262.315368999999976, 52.0, 22.0 ],
					"text" : "pack i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 72.5, 193.5, 29.5, 22.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.75, 262.315368999999976, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 156.25, 227.315368999999976, 29.5, 22.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.25, 354.0, 71.0, 22.0 ],
					"text" : "outputvalue"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.25, 325.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 156.25, 295.315368999999976, 71.0, 22.0 ],
					"text" : "route active"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 297.5, 301.315368999999976, 10.0, 10.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 5.5, 7.0, 7.0 ],
					"rounded" : 15.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 314.25, 262.315368999999976, 150.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 34.0, 18.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
...
,
					"patching_rect" : [ 268.5, 227.315368999999976, 47.0, 22.0 ],
...
,
					"patching_rect" : [ 268.5, 166.815368999999976, 48.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 326.5, 169.315368999999976, 36.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 210.247604000000024, 1.260071000000011, 36.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 0,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 268.5, 197.0, 202.0, 16.753357000000001 ],
					"presentation" : 1,
					"presentation_rect" : [ 27.247604000000024, 0.260071000000011, 181.0, 16.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.5, 170.0, 72.0, 20.0 ],
					"text" : "Source"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.5, 170.0, 72.0, 20.0 ],
					"text" : "Agg Type"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 186.5, 197.0, 72.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 320.0, 1.260071000000011, 72.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
							...
							"parameter_enum" : [ "Orientation", "Acceleration" ]
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 112.5, 197.0, 72.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 246.0, 1.260071000000011, 72.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 2,
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-13::obj-39" : [ "Max[1]", "Max 1", 0 ],
			"obj-19" : [ "live.menu[1]", "live.menu", 0 ],
			"obj-13::obj-20" : [ "Max[8]", "Max 1", 0 ],
			"obj-13::obj-32" : [ "live.toggle", "live.toggle", 0 ],
			"obj-13::obj-26" : [ "Min[8]", "Min 1", 0 ],
