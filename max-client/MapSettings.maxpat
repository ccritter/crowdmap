...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 176.0, 461.5, 29.5, 22.0 ],
					"text" : "*"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 186.5, 430.184631000000024, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.75, 14.0, 318.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 201.75, 40.0, 76.75, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 207.0, 186.760071000000011, 150.0, 18.0 ],
					"text" : "Placeholder",
					"textjustification" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 295.25, 391.876678500000025, 147.0, 22.0 ],
					"text" : "sprintf send crowdmap-%i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 295.25, 422.630035500000076, 49.0, 22.0 ],
					"text" : "forward"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 320.0, 6.760071000000011, 54.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 27.247604000000024, 3.260071000000011, 216.752395999999976, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 3,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 610.0, 312.753356999999994, 150.0, 34.0 ],
					"text" : "Audience mode and Running mode"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 610.0, 351.999999999999943, 162.0, 241.0 ],
					"text" : "Aggregate:\nMap to parameter, choose how it aggregates, what source, and scale.\nData:\nSends data via a forward object (sprintf send crowdmap-%i), gets received in external device receive object. Data is sent raw as a list, unprocessed from a selected source.\nInteractor:\nThis actually won't exist. Instead, you can simply make a 'rest' source with an interesting prompt."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 530.25, 88.0, 29.5, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 530.25, 112.0, 230.0, 22.0 ],
					"text" : "varname \"Bypass 1\", text 1, texton 1",
					"varname" : "Bypass 10"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 530.25, 40.0, 40.0, 22.0 ],
					"text" : "t i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 530.25, 64.0, 264.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 72.5, 146.0, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.5, 445.315368999999976, 79.0, 22.0 ],
					"text" : "s makeconfig"
				}
...
,
					"patching_rect" : [ 530.25, 206.315368999999976, 47.0, 22.0 ],
...
,
					"patching_rect" : [ 530.25, 145.815368999999976, 48.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 588.25, 148.315368999999976, 36.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 210.247604000000024, 31.260071000000011, 36.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_type" : 0,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 530.25, 176.0, 202.0, 16.753357000000001 ],
					"presentation" : 1,
					"presentation_rect" : [ 27.247604000000024, 30.260071000000011, 181.0, 16.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.5, 320.0, 72.0, 20.0 ],
					"text" : "Source"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.5, 379.315368999999976, 72.0, 20.0 ],
					"text" : "Agg Type"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 186.5, 347.0, 72.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 246.0, 6.760071000000011, 72.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "Rest", "Text", "Orientation", "Acceleration" ],
							"parameter_type" : 2,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 186.5, 406.315368999999976, 72.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 246.0, 31.260071000000011, 72.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
